...
+(NSString*)getWS_countXML:(NSString*)udid_str{
	NSString *st =[NSString stringWithFormat:@"http://www.estatelokaler.no/appservice.php?token=getnewpropertiescount&udid=%@",udid_str];
