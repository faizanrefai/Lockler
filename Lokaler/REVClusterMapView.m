...
{ 
    ...
    region.center.latitude = 60.472024;
    region.center.longitude = 8.468946;
    region.span.longitudeDelta = 11.01f;
    region.span.latitudeDelta = 11.01f;
...
- (BOOL) mapViewDidZoom
{
    ...
    zoomLevel = self.visibleMapRect.size.width * self.visibleMapRect.size.height*4;
    return YES;
}
